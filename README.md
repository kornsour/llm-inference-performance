...
| --- | --- | --- | --- | --- |
| no cache — recompute prefix each step, O(T²) | 214 | 598 | 599 | 9.9 |
| **KV-cache** — decode O(T) | **1032** | **124** | **126** | **0.07** |

### 2. Batching — **3.2× throughput** at batch 16

| batch size | 1 | 2 | 4 | 8 | 16 |
| --- | --- | --- | --- | --- | --- |
| tokens/sec | 1037 | 978 | 1809 | 3138 | 3290 |
| speedup vs b=1 | 1.0× | 0.94× | 1.74× | 3.03× | **3.17×** |
...
| p50 latency (ms) | 125 | 279 | *slower on CPU — see note* |
...
hidden — see [`docs/methodology.md`](docs/methodology.md).
...
tests/                  correctness for every optimization (12 tests)
```
...
- **CPU-first, GPU-portable.** Everything runs and is tested on CPU; the CUDA
  kernel and NCCL backend engage unchanged on GPU.
